...
# print(names_sorted)
plot(svmfit, dataNorm_train, ENSG00000101680 ~ ENSG00000255836, fill=TRUE, svSymbol = "v",grid=20)
}# HIDE
```
...
plot(rfe$number_features, rfe$accuracy, xlab = "Features retained", ylab = "Accuracy")
```
...
plot(best_model, dataNorm_train, ENSG00000277559~ENSG00000165507, svSymbol = "v")
```
