...
kopt_gkmeans_sil <- K[which(s_genes_kmeans == max(s_genes_kmeans))]
cat("The maximum silhouette is", s_genes_kmeans[kopt_gkmeans_sil], ", obtained for the optimal number of clusters:", kopt_gkmeans_sil)

cat("\n\nHierarchical clustering over genes!\n")
kopt_ghier_sil <- K[which(s_genes_hierar == max(s_genes_hierar))]
cat("The maximum silhouette is", s_genes_hierar[kopt_ghier_sil], ", obtained for the optimal number of clusters:", kopt_ghier_sil)

cat("\n\nK-Means over samples!\n")
kopt_skmeans_sil <- K[which(s_samples_kmeans == max(s_samples_kmeans))]
cat("The maximum silhouette is", s_samples_kmeans[kopt_skmeans_sil], ", obtained for the optimal number of clusters:", kopt_skmeans_sil)

cat("\n\nHierarchical clustering over samples!\n")
kopt_shier_sil <- K[which(s_samples_hierar == max(s_samples_hierar))]
cat("The maximum silhouette is", s_samples_hierar[kopt_shier_sil], ", obtained for the optimal number of clusters:", kopt_shier_sil)
}# HIDE
```
...
cat("K-Means over genes!\n")
cat("The optimal number of clusters is:", kopt_gkmeans_gap)
...
#GENES, KMEANS
cl_genes<-kmeans(x=dataNorm_clustering, centers = kopt_skmeans_sil, iter.max = 100, nstart = 100)
...
#SAMPLES, KMEANS
cl_samples<-kmeans(x=t(dataNorm_clustering), centers = kopt_skmeans_sil, iter.max = 100, nstart = 100)
